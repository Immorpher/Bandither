...
void main()
{
	...
	ditheramt = dithering; // grab dithering from GZDoom
	dithertype = ditherstyle; // grab dither type from GZDoom
	...
	frag = colround(coloramt, floor(gl_FragCoord.xy/ditherscale), frag); // band it and dither it
	FragColor = frag; // apply color to screen
}